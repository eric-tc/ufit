<template>
  <div class="row">
          ...
          <tr v-for=" (item, index )   in list" :key="item.name">
            <td scope="row">
                <div v-show = "item.edit == false">
                    <label @dblclick = "item.edit = true"> {{item.id}} </label>
                </div>
    ...
    <div v-for="(circuito,numero) in allenamenti_circuito">
      <br>
...
export default {
  ...
  data() {
    return {
      list: [
        { id: 1, name: "Abby", sport: "basket", 'edit':false}
      ],

      allenamenti_circuito:[[{id:"add",name:"test",sport:"",edit:false }]],
      index:"",
      defaticamento:[{id: 1, name: "Esempio", sport: "Add", 'edit':false}],
      edited:null,
      dragging: false
    };
  },methods:{
    ...
    addAllenamento:function(){
        ...
        this.list.push({id:"add",name:"add",sport:"add",edit:false});
    },
    ...
    addCircuito:function(){
        ...
        this.allenamenti_circuito.push([{id:"add",name:"add",sport:"add",edit:false}])
    },

    addCircuitoAllenamento:function(index){


        this.allenamenti_circuito[index].push({id:"add",name:"add",sport:"add",edit:false})
    },
