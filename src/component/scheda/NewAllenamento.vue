            ...
            <td>
              <div v-show="item.serie_edit == false">
                <div v-show="item.serie===''">
                  <label @dblclick="item.serie_edit = true">aggiungi</label>
                </div>
            ...
            <td>
              <div v-show="item.carico_edit == false">
                <div v-show="item.carico===''">
                  <label @dblclick="item.carico_edit = true">aggiungi</label>
                </div>
            ...
            <td>
              <div v-show="item.note_edit == false">
                <div v-show="item.note===''">
                  <label @dblclick="item.note_edit = true">aggiungi</label>
                </div>
